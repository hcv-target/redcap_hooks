...
foreach ($hook_terms[$term] AS $autocomplete_field_name => $values) {
	...
	print "$(\"[name='{$autocomplete_field_name}']\").wrap(\"<span><div class='ui-widget'></div></span>\");\n";
	...
	print "     serviceUrl: \"" . APP_PATH_WEBROOT_FULL . "plugins/Autocomplete/autocomplete_control_ajax.php?pid=" . $project_id . "&f=" . $autocomplete_field_name . "&a=" . $query_field . "\",\n";
	print "     deferRequestBy: 0,\n";
	print "     noCache: false,\n";
	print "     minChars: 2,\n";
	print "     type: \"POST\"\n";
	print "     });\n";
